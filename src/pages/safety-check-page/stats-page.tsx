    ...
    for (let week = 0; week < weeks; week++) {
      ...
      for (let dayOfWeek = 0; dayOfWeek < 7; dayOfWeek++) {
        if ((week === 0 && dayOfWeek < firstDayOfMonth) || dayCount > daysInMonth) {
          ...
          if (isToday) {
            bgColor = 'bg-gradient-to-r from-orange-500 to-amber-600 text-white font-bold shadow-md';
          } else if (completionRate > 0) {
            if (completionRate >= 80) {
              bgColor = 'bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-sm';
            } else if (completionRate >= 60) {
              bgColor = 'bg-gradient-to-r from-green-400 to-emerald-500 text-white shadow-sm';
            } else if (completionRate >= 40) {
              bgColor = 'bg-gradient-to-r from-green-300 to-emerald-400 text-white';
            } else {
              bgColor = 'bg-gradient-to-r from-green-200 to-emerald-300 text-gray-700';
            }
          }
