          ...
          <div>
            ...
            <div className="flex flex-row justify-between items-center px-8 mt-4 gap-4">
              ...
              >
                ...
                <span
                  className={`text-s mt-1 font-medium ${difficulty === 'easy' ? 'text-[#006259]' : 'text-[#B4B4B4]'}`}
                >
                  쉬워요{' '}
                </span>
              </button>
              ...
              >
                ...
                <span
                  className={`text-s mt-1 font-medium ${difficulty === 'normal' ? 'text-[#F78938]' : 'text-[#B4B4B4]'}`}
                >
                  보통이에요
                </span>
              </button>
              ...
              >
                ...
                <span
                  className={`text-s mt-1 font-medium ${difficulty === 'hard' ? 'text-[#FF3E3E]' : 'text-[#B4B4B4]'}`}
                >
                  어려웠어요
                </span>
              </button>
