              ...
              {transports.map((item, idx) => (
                <button
                  ...
                  className={`px-7.5 py-4 rounded-xl outline outline-1 outline-offset-[-1px] 
                    ...
                    ${selectedTransport === item ? 'bg-[#F78937] text-white outline-[#F78937]' : 'bg-white text-gray-600 outline-gray-300'}`}
                >
                  {item}
                </button>
              ))}
            ...
            <div className="flex flex-col gap-2 mt-2">
              ...
              <div className="flex flex-row gap-2 mb-2">
                {selectedPlaces.map((place) => (
                  <div
                    key={place.id}
                    className="flex items-center justify-between border border-[#F78937] rounded-lg p-3 animate-fade-in"
                  >
                    <div className="mr-1">
                    ...
                    <button onClick={() => handleRemovePlace(place.id)}>
                      <CloseIcon />
                    </button>
                  </div>
                ))}
              ...
              <button
                ...
                onClick={() => setNoPlaceSelected((prev) => !prev)}
              >
                관광지 선택없이 계획짜기
              </button>
            </div>
