    ...
    >
      <div className="w-full max-w-[480px] bg-white rounded-xl shadow-[0px_0px_2px_1px_rgba(247,137,56,1.00)] flex flex-col pt-4 pb-2">
        ...
        <div className="flex flex-col font-['Pretendard'] divide-y-[0.5px] divide-[#F78938]">
          <button
            className="flex flex-col items-center gap-3 pb-4 cursor-pointer"
            onClick={() => handleClick('/write-review')}
          >
            <img src={ReviewIcon} alt="혼행 리뷰 작성" className="w-10 h-10" />
            <span className="text-[#F78938] text-xl font-semibold leading-snug tracking-tight">
              혼행 리뷰 작성
            </span>
          </button>
          <button
            className="flex flex-col items-center gap-3 py-4 cursor-pointer"
