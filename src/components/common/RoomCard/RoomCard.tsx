...
const RoomCard = ({
  ...
  return (
    <div
      className="flex w-full h-32 rounded-xl shadow-[0px_0px_2px_0px_rgba(247,137,56,1.00)] border border-[#F78938] overflow-hidden"
    ...
    >
      <div className="flex flex-col justify-between p-4 w-2/3">
        <div className="flex flex-col gap-1">
          ...
          <div className="text-black text-base font-semibold font-['Pretendard'] leading-tight tracking-tight">
            {title}
          </div>
        </div>
      ...
      <div className="relative w-1/3 flex items-end justify-end p-2">
        <div
          className={`absolute top-4 right-4 z-10 flex items-center gap-1 rounded ${!imageUrl ? 'text-[#F78938]' : 'text-white'}`}
        >
